...
![image-20211221175531854](http://img.zssaer.cn/image-20211221175531854.png)
...
![](http://img.zssaer.cn/o_jieou5.png)
...
![](http://img.zssaer.cn/o_jieou6.png)
...
![](http://img.zssaer.cn/o_yibu2.png)

使用传统模式设计，一些非必要的业务逻辑以同步的方式运行，太耗费时间。

**中间件模式:**

![](http://img.zssaer.cn/o_yibu3.png)
...
![](http://img.zssaer.cn/o_xuefeng1.png)

使用传统模式设计，并发量大的时候，所有的请求直接一个一个怼到数据库，造成数据库连接异常。

**中间件模式:**

![](http://img.zssaer.cn/o_xuefeng2.png)
...
![](http://img.zssaer.cn/285763-20190821175219196-1211062486.png)
...
![](http://img.zssaer.cn/285763-20190813181031834-879282107.png)
...
![image-20211221175612800](http://img.zssaer.cn/image-20211221175612800.png)

点击 集群 ,我们也可以轻松看见当前的Broker服务器状态:

![image-20211221175621335](http://img.zssaer.cn/image-20211221175621335.png)
...
![](http://img.zssaer.cn/7632473-581d29f7eb055cb9.webp)

此时，在消费者界面按下`Ctrl + C`，就会收到刚刚生产者发出的消息。

![](http://img.zssaer.cn/7632473-56e329cea742e9f7.webp)
