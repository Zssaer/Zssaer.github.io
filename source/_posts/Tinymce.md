---
    ...
    - 前端
    categories: 前端 # 分类
    thumbnail: https://zssaer-img.oss-cn-chengdu.aliyuncs.com/JrAJTf-aHsc.jpg?x-oss-process=style/small # 略缩图
---
# TinyMCE富文本编辑器
...
![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/tinyMCE.png)
### TinyMCE是否收费
...
2. 汉化编辑器
   ...
   TinyMCE是国外的插件,所以自然默认为英文版本,需要使用中文的话,要去官网下载汉化包:
    ...
    ![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/tinyMCE-CN.png)
