---
    ...
    - 其他
    categories: 其他 # 分类
    thumbnail: https://zssaer-img.oss-cn-chengdu.aliyuncs.com/wallhaven-281d5y.png?x-oss-process=style/wallpaper # 略缩图
---
...
![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/Chinese.png)

![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/Chinese2.png)

相较于民间汉化插件，使用官方中文汉化版本，在获取代码信息上更加方便，毕竟中文显示极大方便了IDEA使用。

![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/Chinese3.png)
...
![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/translation1.png)
...
![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/translation2.png)
...
<img src="https://zssaer-img.oss-cn-chengdu.aliyuncs.com/AlibabaCoding.png"  />
...
![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/screenshot_19077.png)

也可以从Github上进行源码拷贝自动补全。前提是当前网络能够访问GitHub。



![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/screenshot_20415.png)
...
![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/screenshot_23132.png)
...
![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/screenshot_17373.png)
...
![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/maven.png)
...
![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/junit1.png)

然后需要更改模板中的默认包引用,默认为test下,我们需要手动去掉:

![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/junit2.png)

随后便可以开始使用插件生成单元测试方法，打开某个服务层的类 按 Alt+Insert 快捷键调出构建面板，然后选择Junit Test -》junit4 ，这个时候单元测试的方法就生成了。

![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/junit3.png)
...
![](https://zssaer-img.oss-cn-chengdu.aliyuncs.com/sonarlint.png)
