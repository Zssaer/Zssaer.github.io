---
    ...
    - JAVA
    categories: JAVA # 分类
    thumbnail: http://img.zssaer.cn/marek-piwnicki-JNiYQHi5Hjc-unsplash.jpg?x-oss-process=style/wallpaper # 略缩图 
---
...
![](http://img.zssaer.cn/43697219-3cb4ef3a-9975-11e8-9a9c-73f4f537442d.png)
...
![](http://img.zssaer.cn/20191130203727708.png)



目前使用该技术栈的公司有(不完全统计):

![](http://img.zssaer.cn/sentinel1.png)
...
![](http://img.zssaer.cn/20210818172249.png)

登陆成功后，进入控制台页面，但由于控制台本身配置中未说明其他客户端服务，所以为一片空白。

![](http://img.zssaer.cn/20210818172500.png)
...
![](http://img.zssaer.cn/20210818173652.png)

其中实时监控中*实时显示*了对应的接口QPS调用情况，以及响应时间。

进入**簇点链路**，可以更主观显示了对应的接口调用情况，并且提供了一些操作，这些操作可以直接在控制台中快速实现，而不需要在客户端中进行编写对应代码。

![](http://img.zssaer.cn/20210818174150.png)

### 配置限流规则

对需要进行限流的接口上点击`+流控`按钮:

![](http://img.zssaer.cn/626506-20190410140119112-664951384.png)
...
![](http://img.zssaer.cn/20210819111859.png)
...
![](http://img.zssaer.cn/20210819114455.png)
...
![](http://img.zssaer.cn/20210819142325.png)

先在单机阈值10/3，3的时候，预热10秒后，慢慢将阈值升至20。刚开始请求，会出现默认错误，预热时间到了后，阈值增加，没超过阈值刷新，请求正常。

通常冷启动的过程系统允许通过的 QPS 曲线如下图所示：

![](http://img.zssaer.cn/9922720e0cf3d7ca95ce8b6db1dd310f6b63a93e.png)
...
![](http://img.zssaer.cn/42166d224f4a20a4de73da50d0901724730ed005.png)
...
![](http://img.zssaer.cn/20191025165126419.png)
...
![](http://img.zssaer.cn/20210819164228.png)
...
![](http://img.zssaer.cn/20210819165833.png)
...
# 本文Markdown文件在线下载:  http://img.zssaer.cn/markdown/sentinel.md
